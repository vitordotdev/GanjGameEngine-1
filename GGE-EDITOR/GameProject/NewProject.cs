...
namespace GGE_EDITOR.GameProject
{
    ...
    class NewProject : ViewModelBase
    {
        ...
        private readonly string _templatePath = @"..\..\GGE-EDITOR\ProjectTemplates\";
        private string _projectName = "NewProject";
        public string ProjectName { get => _projectName; set { if (_projectName != value) { _projectName = value; ValidateProjectPath(); OnPropertyChanged(nameof(ProjectName)); } } }

        private string _projectPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments)}\GGProjects\";
        public string ProjectPath { get => _projectPath; set { if (_projectPath != value) { _projectPath = value; ValidateProjectPath(); OnPropertyChanged(nameof(ProjectPath)); } } }

        private bool _isValid;
        public bool IsValid { get => _isValid; set { if (_isValid != value) { _isValid = value; OnPropertyChanged(nameof(IsValid)); } } }

        private string _errorMSG;
        public string ErrorMSG { get => _errorMSG; set { if (_errorMSG != value) { _errorMSG = value; } OnPropertyChanged(nameof(ErrorMSG)); } }
        ...
        public string CreateProject(ProjectTemplate template)
        {
            ...
            try
            {
                ...
                var dirInfo = new DirectoryInfo(path + @".GGE\");
